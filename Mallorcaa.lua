...
io.popen("cd library && wget https://raw.githubusercontent.com/MallorcaaTEAM/Mallorcaa/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MallorcaaTEAM/Files_Mallorcaa/main/File_Bot/commands.lua") 
...
function MallorcaaSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMallorcaaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local Mallorcaa_Msg = ''  
if msgs < 100 then 
Mallorcaa_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Mallorcaa_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Mallorcaa_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Mallorcaa_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Mallorcaa_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Mallorcaa_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Mallorcaa_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Mallorcaa_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Mallorcaa_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Mallorcaa_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Mallorcaa_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Mallorcaa_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Mallorcaa_Msg = 'رب التفاعل'  
end 
return Mallorcaa_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMallorcaa(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Mallorcaa1:List:Filter"..sl)
...
if not DevMallorcaaW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMallorcaaW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Mallorcaa_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevMallorcaaW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevMallorcaaW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevMallorcaaW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevMallorcaaW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevMallorcaaW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevMallorcaaW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevMallorcaaW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevMallorcaaW(msg) then 
os.execute('rm -rf Mallorcaa.lua')
os.execute('wget https://raw.githubusercontent.com/MallorcaaTEAM/Mallorcaa/main/Mallorcaa.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس تيلاند*\n*⌯︙الاصدار » { 2.8v}*')
dofile('Mallorcaa.lua')  
end
if text == 'الاصدار ⌯' and DevMallorcaaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس تيلاند* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevMallorcaaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/MallorcaaTEAM) \n⌯︙[قناه السورس](t.me/vvvmh)')
end
if text == "ضع اسم للبوت ⌯" and DevMallorcaaW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevMallorcaaW(msg) then 
...
if text == 'المشتركين ⌯' and DevMallorcaaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevMallorcaaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevMallorcaaW(msg) then
...
if text == ("قائمه العام ⌯") and DevMallorcaaW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevMallorcaaW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevMallorcaaW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevMallorcaaW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevMallorcaaW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevMallorcaaW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevMallorcaaW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevMallorcaaW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevMallorcaaW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevMallorcaaW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..Mallorcaak..''..Mallorcaa..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMallorcaaW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevMallorcaaW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMallorcaaW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMallorcaaW(msg) then
...
local Mallorcaa1_Msg = database:get(bot_id.."Mallorcaa1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Mallorcaa1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Mallorcaa_Msg and not Special(msg) then  
local Mallorcaa_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMallorcaaW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMallorcaaW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMallorcaaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMallorcaaW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevMallorcaaW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevMallorcaaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevMallorcaaW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevMallorcaaW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevMallorcaaW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Mallorcaa:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Mallorcaa:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Mallorcaa = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Mallorcaa then 
names_Mallorcaa = database:smembers(bot_id.."Mallorcaa:blocname"..msg.chat_id_) or ""
if names_Mallorcaa and names_Mallorcaa[1] then 
for i=1,#names_Mallorcaa do 
if name_Mallorcaa:match("(.*)("..names_Mallorcaa[i]..")(.*)") then 
...
database:set(bot_id.."Mallorcaa:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Mallorcaa:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Mallorcaa:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Mallorcaa:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Mallorcaa:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Mallorcaaa_new(Mallorcaa1,Mallorcaa2)
if Mallorcaa2 and Mallorcaa2.first_name_ then 
if Mallorcaa2.first_name_:match("(.*)"..database:get(bot_id.."Mallorcaa:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Mallorcaa:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Mallorcaa_nnn = database:get(bot_id.."Mallorcaa:nump"..msg.chat_id_) or 5
local Mallorcaa_nnn2 = database:get(bot_id.."Mallorcaa:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Mallorcaa_nnn2) == tonumber(Mallorcaa_nnn) or tonumber(Mallorcaa_nnn2) > tonumber(Mallorcaa_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Mallorcaa:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..Mallorcaa2.username_.."](https://t.me/"..(Mallorcaa2.username_ or "vvvmh")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Mallorcaa:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(Mallorcaa_nnn) - tonumber(Mallorcaa_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Mallorcaaa_new)
end
end
...
local MallorcaaChengName = database:get(bot_id.."Mallorcaa:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MallorcaaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MallorcaaChengName..']')
database:del(bot_id.."Mallorcaa:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MallorcaaChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Mallorcaa:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MallorcaaChengUserName = database:get(bot_id.."Mallorcaa:Cheng:UserName"..data.id_)
if not data.username_ then 
if MallorcaaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MallorcaaChengUserName..']')
database:del(bot_id.."Mallorcaa:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MallorcaaChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Mallorcaa:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MallorcaaChengPhoto = database:get(bot_id.."Mallorcaa:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MallorcaaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Mallorcaa:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MallorcaaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Mallorcaa:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://vvvzvv.ml/apiMallorcaa/Mallorcaa.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @MallorcaaTEAM .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ\n\n[⌯  ᴛᴇʟᴀɴᴅ ᴄʜᴀɴɴᴇʟ](http://t.me/MallorcaaTEAM)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/vvvmh)\n\n[⌯  ᴛᴇʟᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/IMMHH)\n\n[⌯  ʙᴏᴛ ᴛᴇʟᴀɴᴅ](http://t.me/Tilllandbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url="t.me/MallorcaaTEAM/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MallorcaaTEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevMallorcaaW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevMallorcaaW(msg) then
dofile('Mallorcaa.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevMallorcaaW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMallorcaaW(msg) then  
function start_function(extra, result, success)
if MallorcaaSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMallorcaaW(msg) then  
...
if MallorcaaSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevMallorcaaW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if MallorcaaSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMallorcaaW(msg) then  
function start_function(extra, result, success)
if MallorcaaSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevMallorcaaW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevMallorcaaW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if MallorcaaSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMallorcaaW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevMallorcaaW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevMallorcaaW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevMallorcaaW(msg) then
...
if text == 'الملفات' and DevMallorcaaW(msg) then
...
if DevMallorcaaW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MallorcaaTEAM/Files_Mallorcaa/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMallorcaaW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MallorcaaTEAM/Files_Mallorcaa/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMallorcaaW(msg) then
...
if text == "مسح الملفات" and DevMallorcaaW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMallorcaaW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMallorcaaW(msg) then  
function start_function(extra, result, success)
...
local TEXT_SUD = database:get(bot_id..'Mallorcaa:TEXT_SUDO')
if TEXT_SUDO then 
...
database:set(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Mallorcaa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Mallorcaa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Mallorcaa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Mallorcaa1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Mallorcaa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Mallorcaa1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Mallorcaa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Mallorcaa1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Mallorcaa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Mallorcaa1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Mallorcaa1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevMallorcaaW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMallorcaaW(msg) then
...
if text == 'تفعيل الاذاعه' and DevMallorcaaW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMallorcaaW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Mallorcaa_Msg[math.random(#Mallorcaa_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMallorcaaW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Mallorcaa)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
x = 0
local list = Mallorcaa.members_
for k, v in pairs(list) do
x = x + 1
...
if MallorcaaSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMallorcaaW(msg) then 
...
if text == ("ردود المطور") and DevMallorcaaW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMallorcaaW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevMallorcaaW(msg) then    
...
if text == 'تفعيل المغادره' and DevMallorcaaW(msg) then   
...
if text == 'تعطيل المغادره' and DevMallorcaaW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MallorcaaTEAM')..') '
...
-- vardump(data) 
Mallorcaadx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMallorcaaW(msg) then
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/MallorcaaTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/Mallorcaa.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝗧𝗘 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/Mallorcaa.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/Mallorcaa.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/Mallorcaa.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/MallorcaaTEAM'}},
}
...
*⌯~⪼ الاشعارات*
*ٴ•━━━━━━ 𝗧𝗘 ━━━━━━━•*
[⍆ 𝘛𝘌𝘓𝘈𝘕𝘋 𝘛𝘦𝘈𝘮](t.me/MallorcaaTEAM)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اوامر الحمايه', callback_data="/help1"},{text = 'اوامر الادمنيه', callback_data="/help2"}},
...
Mallorcaa = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Mallorcaa)
...
--------------------------------------------------------------------------------------------------------------
SourceMallorcaa(data.message_,data)
...
------------------------------------------------------------------------
local MallorcaaAbot = database:get(bot_id.."Mallorcaa1:Add:Filter:Rp2"..text..result.chat_id_)   
if MallorcaaAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..MallorcaaAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local Mallorcaa1_Msg = database:get(bot_id.."Mallorcaa1:Add:Filter:Rp2"..text..result.chat_id_)   
if Mallorcaa1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..Mallorcaa1_Msg)
