...
local NameUser = "[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/aaaaw)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/aaaaw)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/aaaaw)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "aaaaw")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Mallorcaa TeAM .',url="t.me/aaaaw"}},
}
local msg_id = msg.id_/2097152/0.5
...
[⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/aaaaw)
     
[⌔︙ Mallorcaa Developer .](http://t.me/nnnnn)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
inline = {
{{text = '⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/aaaaw'}},
}
...
inline = {
{{text = '⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/aaaaw'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
