...
local NameUser = "[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrbe)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrbe)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrbe)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "rrrbe")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if text == (database:get(bot_id.."Mallorcaa:Name:Bot") or "كراند") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Mallorcaa:Name:Bot") or "كراند")
local namebot = {
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'Mallorcaa:Lock:ID:Bot'..msg.chat_id_) then
...
os.execute('wget https://raw.githubusercontent.com/SourceMallorcaa/Mallorcaa/master/Mallorcaa.lua')
os.execute('wget https://raw.githubusercontent.com/SourceMallorcaa/Mallorcaa/master/start.lua')
...
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Mallorcaa:insta_bot"..msg.chat_id_) == "open" then
local Textni = text:match("^معلومات (.*)$")
data,res = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
if DevMallorcaa(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceMallorcaa/files_Mallorcaa/master/getfile.json")
if res == 200 then
...
[⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/rrrbe)
     
[⌔︙ Mallorcaa Developer .](http://t.me/devmallo)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
inline = {
{{text = '⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/rrrbe'}},
}
...
inline = {
{{text = '⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/rrrbe'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
local Name_Bot = (database:get(bot_id.."Mallorcaa:Name:Bot") or "كراند")
