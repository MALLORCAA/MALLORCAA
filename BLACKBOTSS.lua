...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,5006696177,1960752989}
...
local NameUser = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrbe)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrbe)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if tonumber(userid) == tonumber(5006696177) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrbe)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "rrrbe")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://black-source.tk/MallorcaTeAM/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
zh = https.request('https://black-source.tk/MallorcaTeAM/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⌔︙قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://black-source.tk/MallorcaTeAM/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://black-source.tk/MallorcaTeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
...
request = https.request('https://black-source.tk/MallorcaTeAM/infoInstagram.php?username='..URL.escape(text:match("^معلومات (.*)$")))
...
data,res = https.request('https://black-source.tk/MallorcaTeAM/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://black-source.tk/MallorcaTeAM/audios.php')
if res == 200 then
...
st = https.request('https://black-source.tk/MallorcaTeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://black-source.tk/MallorcaTeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local url,res = https.request('https://black-source.tk/MallorcaTeAM/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
gk = https.request('https://black-source.tk/MallorcaTeAM/Horoscopes.php?br='..URL.escape(OnID))
br = JSON.decode(gk)
x = {} 
x.inline_keyboard = {
...
https.request("https://black-source.tk/MallorcaTeAM/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
https.request("https://black-source.tk/MallorcaTeAM/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
