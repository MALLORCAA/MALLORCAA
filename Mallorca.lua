...
if text == (database:get(bot_id.."Mallorca:Name:Bot") or "بلاك") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Mallorca:Name:Bot") or "بلاك")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/Mallorca/DevRod/main/Mallorca.lua')
os.execute('wget https://raw.githubusercontent.com/Mallorca/DevRod/main/start.lua')
dofile('Mallorca.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."Mallorca:Qut"..msg.chat_id_,true)
end
if text == "تفعيل كت تويت" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌔︙ تم تفعيل كت تويت')
database:del(bot_id.."Mallorca:Qut"..msg.chat_id_)
end
if text == "كت" or  text == "كت تويت" and not  database:get(bot_id.."Mallorca:Qut"..msg.chat_id_) then
...
if text == "الابراج" and database:get(bot_id.."Mallorca:brj_Bots"..msg.chat_id_) == "open" then
key = {
...
if database:get(bot_id.."Mallorca:insta_bot"..msg.chat_id_) == "open" then
...
if text == 'الملفات' and DevMallorca(msg) then
t = '⌔︙جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls Mallorca_Files'):lines() do
if v:match(".lua$") then
...
if DevMallorca(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Mallorca/files_Mallorca/main/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("Mallorca_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevMallorca(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("Mallorca_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/Mallorca/files_Mallorca/master/files_Mallorca/"..file)
if res == 200 then
os.execute("rm -fr Mallorca_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Mallorca.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevMallorca(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Mallorca/files_Mallorca/master/files_Mallorca/"..file)
if res == 200 then
local chek = io.open("Mallorca_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevMallorca(msg) then
os.execute("rm -fr Mallorca_Files/*")
...
os.execute('rm -rf Mallorca.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/Mallorca/Mallorca/master/Mallorca.lua')
os.execute('wget https://raw.githubusercontent.com/Mallorca/Mallorca/master/start.lua')
dofile('Mallorca.lua')  
return false
end
...
if database:get(bot_id.."Mallorca:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_) then
database:del(bot_id.."Mallorca:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_)
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Name_Bot = (database:get(bot_id.."Mallorca:Name:Bot") or "بلاك")
